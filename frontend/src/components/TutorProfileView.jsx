                ...
                <div className='flex justify-between items-center'>
                    ...
                    <div className='flex items-center gap-3'>
                        ...
                        <Link to={dashboardPath} className='hidden md:block'>
                            <button className='flex items-center bg-blue-600 text-white py-2 px-4 border-2 border-white rounded-full font-semibold hover:bg-blue-700 transition-colors text-sm'>
                                {loggedInName ? (
                ...
                {mobileMenuOpen && (
                    <div className='md:hidden mt-4 flex flex-col gap-3 pb-4 border-t border-blue-800 pt-4'>
                        ...
                        <Link to={dashboardPath} onClick={() => setMobileMenuOpen(false)}>
                            <button className='flex items-center bg-blue-600 text-white py-2 px-4 border-2 border-white rounded-full font-semibold text-sm'>
